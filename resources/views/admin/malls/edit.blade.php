...
<?php
$lat = !empty($mall->lat)?$mall->lat:'24.7461627';
$lng = !empty($mall->lng)?$mall->lng:'46.6607619';
...
<div class="card">
    ...
    <input type="hidden" value="{{ $lng }}" id="lng" name="lng">
      ...
      <div class="form-group">
        ...
        {!! Form::text('address_ar',$mall->address_ar,['class'=>'form-control']) !!}
      </div>


      <div class="form-group">
        {!! Form::label('address_en', trans('admin.address_en')) !!}
        {!! Form::text('address_en',$mall->address_en,['class'=>'form-control']) !!}
      </div>
      ...
      <div class="form-group">
        ...
        {!! Form::select('active', ['1' => trans('admin.active'), '0' => trans('admin.inactive')],$mall->active,['class'=>'form-control']) !!} 
      </div>
      <br/>
