...
class AttributeDatatable extends DataTable
{
     ...
     *
     * @param \App\Model\Attribute $model
    ...
    {
        return $this->builder()
                    ->setTableId('Attributedatatable-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('attribute_family_id')
            ->title(trans('admin.attribute_family_id'))
            ->data('attributeFamily.name_'.session('lang'))
            ->name('attributeFamily.name_'.session('lang')),
