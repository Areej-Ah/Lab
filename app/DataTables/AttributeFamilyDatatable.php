...
class AttributeFamilyDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.attribute_families.btn.checkbox')
            ->addColumn('edit', 'admin.attribute_families.btn.edit')
            ->addColumn('delete', 'admin.attribute_families.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
                'checkbox',
     ...
     *
     * @param \App\Model\AttributeFamily $model
    ...
    {
        return $this->builder()
                    ->setTableId('AttributeFamilydatatable-table')
    ...
    {
        return 'AttributeFamily_' . date('YmdHis');
    }
}
